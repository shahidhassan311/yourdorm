...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            ...
            <h2><span class="fa fa-arrow-circle-o-left"></span>   {{ $users->name }}</h2>
                @endforeach
        </div>
        <!-- END PAGE TITLE -->
                        ...
                        <div class="panel-body">
                            <table class="table datatable">
                                ...
                                <tr>
                                    ...
                                    <th>distance_of_uni</th>
                                    <th>price_range_per_month</th>
                                    <th>length_of_lease</th>
                                    <th>move_in_date</th>
                                    <th>parking</th>
                                ...
                                <tbody>
                                @foreach($user_history_detail as $user_history_details)
                                    <tr>
                                        <td>{{ $user_history_details->property_type }}</td>
                                        <td>{{ $user_history_details->no_of_bedroom }}</td>
                                        <td>{{ $user_history_details->uni_college }}</td>
                                        <td>{{ $user_history_details->transportation }}</td>
                                        <td>{{ $user_history_details->distance_of_uni }}</td>
                                        <td>{{ $user_history_details->price_range_per_month }}</td>
                                        <td>{{ $user_history_details->length_of_lease }}</td>
                                        <td>{{ $user_history_details->move_in_date }}</td>
                                        <td>{{ $user_history_details->parking }}</td>
                                        <td>{{ $user_history_details->additional_comments }}</td>
