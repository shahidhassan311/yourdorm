                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table datatable">
                                ...
                                <tbody>
                                @foreach($user_history as $user_historys)
                                    <tr>
                                        <td>{{ $user_historys->id }}</td>
                                        <td>{{ $user_historys->name }}</td>
                                        <td>{{ $user_historys->contact }}</td>
                                        <td>{{ $user_historys->packege_type }}</td>
                                        <td>
                                            <a href="/customer_history_detail/{{ $user_historys->id }}">
